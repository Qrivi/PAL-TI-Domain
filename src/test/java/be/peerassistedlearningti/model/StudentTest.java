...
public class StudentTest extends ValidationTest
{
    ...
    {
        Student s = new Student( null, "paswoord", "davidopdebeeck@hotmail.com", "david.op.de.beeck", UserType.ADMIN );
    ...
    {
        Student s = new Student( "David", null, "davidopdebeeck@hotmail.com", "david.op.de.beeck", UserType.ADMIN );
    ...
    {
        Student s = new Student( "David", "paswoord", null, "david.op.de.beeck", UserType.ADMIN );
    ...
    {
        Student s = new Student( "David", "paswoord", "davidopdebeeckhotmailcom", "david.op.de.beeck", UserType.ADMIN );
    ...
    {
        Student s = new Student( "David", "paswoord", "davidopdebeeck@hotmail.com", "david.op.de.beeck", null );
    ...
    public void testSecurityTokenIsNull()
    {
        ...
        Assert.assertEquals( 1, constraintViolations.size() );
        Assert.assertEquals( "Student security token should not be empty!", constraintViolations.iterator()
                .next()
                .getMessage() );
    }
    ...
    {
        Student s = new Student( "David", "paswoord", "davidopdebeeck@hotmail.com", null, UserType.ADMIN );

        Set<ConstraintViolation<Student>> constraintViolations = validator.validateProperty( s, "profileIdentifier" );

        Assert.assertEquals( 1, constraintViolations.size() );
        Assert.assertEquals( "Student profile identifier should not be empty!", constraintViolations.iterator()
                .next()
                .getMessage() );
    }
